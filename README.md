# genpark-commercial-catchment-area-profiler-skill
...
**genpark-commercial-catchment-area-profiler-skill** is a deterministic, zero-dependency Python skill engineered for autonomous geospatial analysis, GeoJSON feature generation, and spatial reachability intelligence.

> **Executive Capability**: Retail commercial catchment area & foot-traffic profiler (Carto / Atlas)
...
result = client.profile_store_catchment()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-commercial-catchment-area-profiler-skill": {
      "command": "python",
      "args": ["/path/to/genpark-commercial-catchment-area-profiler-skill/mcp_server.py"]
    }
  }
}
```
